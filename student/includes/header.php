<?php
    ...
    include("../middleware/studentMiddleware.php");
    
    // TPO sidebar links
    $links = [
        ['title' => 'Home', 'url' => 'index.php', 'icon' => 'fa-house' ],
        ['title' => 'Jobs', 'url' => 'jobs.php', 'icon' => 'fa-briefcase' ],
        ['title' => 'Applied', 'url' => 'applied.php', 'icon' => 'fa-file' ],
        ['title' => 'Offers', 'url' => 'offers.php', 'icon' => 'fa-envelope-open-text' ],
        ['title' => 'Notifications', 'url' => 'notifications.php', 'icon' => 'fa-bell' ],
...
<head>
    ...
    <title>Campus Gateway | Student</title>
</head>
<body>
